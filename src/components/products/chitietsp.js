              ...
              <div class="col-span-1 bg-white p-4 border-r border-gray-200">
                ...
                <div className="flex">
                  <img
                    ...
                    alt={get.Product.name}
                    className="w-[75px] h-[75px] object-contain border inline-block mr-2"
                  />
                  <img
                    src={
                      img +
              ...
              <div class="col-span-1 bg-white mt-8 ml-8">
                ...
                <div className="mt-8 bg-red-50 mr-2 p-4 mb-8 rounded-2xl">
                  <p className="ml-4 mb-4">
                    {' '}
                    <CheckIcon /> Giao hàng trên toàn quốc
                  </p>
                  <p className="ml-4">
                    {' '}
                    <CheckIcon /> Vận chuyển: 24/7
                  </p>
                  <p className="ml-4 mt-4">
                    {' '}
                    <CheckIcon /> Kiểm tra khi nhận hàng
                  </p>
                </div>
                <hr></hr>
                ...
                <div className="py-5 ml-4 mt-2 flex items-center">
                  ...
                  <span className="px-2 py-1 bg-gray-200 w-[35px] text-center">
                    {count}
                  </span>
                  <button
            ...
            <div class="grid grid-cols-5 gap-6">
                ...
                <table className="table-auto mt-4">
                  <tbody className="flex flex-col">
                    <tr className="flex flex-row">
                      <td className="min-w-[200px] text-left bg-red-50  px-4 py-2">
                        Công ty phát hành
                      </td>
                      <td className="min-w-full text-left font-light px-4 py-2">
                        Mekong Group
                      </td>
                    </tr>
                    <tr className="flex flex-row">
              ...
              <div class="w-full col-span-3 bg-white p-4">
                ...
                <p className="ml-2 mt-2">
                  {get.Product.custom_attributes[0].value.replace(
                    /<\/?p>/g,
                    ''
                  )}
                </p>
