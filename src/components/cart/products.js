        ...
        {get.Product.map((product) =>  (
          <div key={product.id}> 
              ...
              <div className="product-item col-span-1 border-2 rounded-lg">
                <Link onClick={()=>handle()} to={`chitietsp/${product.sku}`} >
                ...
                <div className="product-price mt-2 mb-4 flex">
                  ...
                  <Link onClick={()=>handlecart(product.sku)}  className="ml-auto mr-4 hover:bg-gray-300 rounded-full w-8 h-8 flex justify-center items-center">
                    <AddShoppingCartIcon />
                  </Link>
                </div>
              </div>
