      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="text-gray-400">
              <li className="mb-2">
                <i className="fas fa-map-marker-alt mr-2"></i>Hotline: (+84) 939 814 858
              </li>
              <li className="mb-2">
                <i className="fas fa-phone-alt mr-2"></i>Email: Sales@scadaautomation.com.vn
              </li>
            </ul>
          </div>
          <div className="col-span-1">
            <h3 className="text-lg font-bold text-white mb-4">FANPAGE SCADA AUTOMATION</h3>
            <ul className="text-gray-400">
              <li className="mb-2">
        ...
        <div className="mt-8 border-t border-gray-700 pt-8">
          <p className="text-base text-gray-400">
            © 2023 SCADAAutomation. All rights Reserved. Designed by Brands Viet Agency.
          </p>
        </div>
      </div>
    </footer>
