...
function Search() {
  ...
  return (
    <div className="w-full fixed ">
            ...
            <div className="col-span-1 ">
              <ul className="text-gray-400 mt-4 cursor-pointer ">
                <li>
                  <a
                    href="#"
                    className="text-black dark:text-white  hover:bg-gray-300 focus:bg-4 focus:bg-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"
                  >
                    Iot
                  </a>
                </li>
      ...
      {isSearch &&(
          <div className=" w-[640px] bg-gray-100 animate min-h-screen ml-auto absolute top-0 right-0 z-50 shadow-lg " style={{boxShadow: '0 0 1000px rgba(200, 0, 0,0.5)'}}>
